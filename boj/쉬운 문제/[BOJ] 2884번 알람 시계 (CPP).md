...
백준온라인저지(BOJ) https://www.acmicpc.net/problem/2884
...
| :-------- | :---------- | :---- | :--- | :-------- | :-------- |
| 1 초      | 128 MB      | 10050 | 4850 | 4575      | 50.297%   |
...
단순히 입력 받은 시각에 45분을 뺀 시각을 출력하는 문제. 24시간 기준으로 한다는 것 빼고는 주의할 점이 딱히 없다..

가독성을 위해 일부러 min-45+60;과 같은 형식으로 썼다
